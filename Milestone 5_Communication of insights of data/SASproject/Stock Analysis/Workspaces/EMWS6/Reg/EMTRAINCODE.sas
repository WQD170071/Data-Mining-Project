...
;
;
code file="G:\SASproject\Stock Analysis\Workspaces\EMWS6\Reg\EMPUBLISHSCORE.sas"
group=Reg
;
code file="G:\SASproject\Stock Analysis\Workspaces\EMWS6\Reg\EMFLOWSCORE.sas"
group=Reg
residual
;
run;
