...
def price_csv():
    df_list = []
    url = 'https://raw.githubusercontent.com/LM-D/hello-world/master/Price_csv/Day_'
...
def sector_csv():
    df_list = []
    url = 'https://raw.githubusercontent.com/LM-D/hello-world/master/Sector_csv/sector'
